        ...
        <div class="vh-100 d-flex justify-content-center align-items-center">
            <div class="card col-md-4 bg-white shadow-md p-5">
                ...
                <div class="text-center">
                    <h1>Thank You !</h1>
                    <p>Pendafataran Anda Telah Kami Terima, Silahkan Menunggu Tim Kami Menghubungi Melalui Kontak Yang Telah Disubmit</p>
                    <a href="index.php" class="btn btn-outline-warning">Back Home</a>
                </div>
            </div>
        </div>
